...
import com.teximobilitydriver.BuildConfig;
...
import com.teximobilitydriver.databinding.ActivityRegisterBinding;
import com.teximobilitydriver.helper.App;
import com.teximobilitydriver.helper.DataManager;
...
import static com.teximobilitydriver.retrofit.Constant.emailPattern;
...
public class RegisterAct extends AppCompatActivity implements NetworkReceiver.ConnectivityReceiverListener {
                    ...
                    public void Success(String response) {
                        ...
                        try {
                            ...
                            if (object.getString("status").equals("1")){
                                ...
                                login_sts = "no";
                                Toast.makeText(RegisterAct.this, object.getString("message"), Toast.LENGTH_LONG).show();
                            }
    ...
    private HashMap<String,String>getParam(){
        ...
        param.put("user_name",binding.etName.getText().toString());
