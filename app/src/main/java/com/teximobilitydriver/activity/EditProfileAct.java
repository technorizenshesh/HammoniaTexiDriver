...
import com.teximobilitydriver.databinding.ActivityEditProfileBinding;
...
public class EditProfileAct extends AppCompatActivity implements NetworkReceiver.ConnectivityReceiverListener {
    ...
    private void updateProfile() {
        ...
        Call<SignupModel> signupCall = apiInterface.editprofile( user_id,f_name, email, mobile_number,countrty_code, filePart);
